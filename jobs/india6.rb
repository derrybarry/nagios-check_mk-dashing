...
doc = Nokogiri::XML(open("http://+++/pnp4nagios/xport/xml?host=kilo&srv=CPU_utilization", http_basic_authentication: ["login", "pwd"]).read)	# load it into the nokogiri gem
...
data3 = data[0..-1]
  ...
  send_event('graph6', points: data3)
