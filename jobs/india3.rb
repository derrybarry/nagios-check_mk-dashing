...
doc = Nokogiri::XML(open("http://+++/pnp4nagios/xport/xml?host=papa&srv=CPU_utilization", http_basic_authentication: ["login", "pwd"]).read)	# load it into the nokogiri gem
...
data3 = data[0..-1]
  ...
  send_event('graph3', points: data3)
