...
doc = Nokogiri::XML(open("http://+++/pnp4nagios/index.php/xml?host=kilo&srv=CPU_utilization", http_basic_authentication: ["login", "pwd"]).read)	# load it into the nokogiri gem
...
send_event('kilo', value: metervalue)	#send to dashboard
end
