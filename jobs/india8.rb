...
doc = Nokogiri::XML(open("http://+++/pnp4nagios/xport/xml?host=SQL2008R2&srv=CPU_utilization", http_basic_authentication: ["login", "pwd"]).read)	# load it into the nokogiri gem
...
data3 = data[0..-1]
  ...
  send_event('graph8', points: data3)
