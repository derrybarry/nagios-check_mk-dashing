...
doc = Nokogiri::XML(open("http://+++/pnp4nagios/index.php/xml?host=quebec&srv=CPU_utilization", http_basic_authentication: ["login", "pwd"]).read)	# load it into the nokogiri gem
...
send_event('quebec', value: metervalue)	#send to dashboard
end
