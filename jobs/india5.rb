...
doc = Nokogiri::XML(open("http://+++/pnp4nagios/xport/xml?host=juliet3&srv=CPU_utilization", http_basic_authentication: ["login", "pwd"]).read)	# load it into the nokogiri gem
...
data3 = data[0..-1]
  ...
  send_event('graph5', points: data3)
